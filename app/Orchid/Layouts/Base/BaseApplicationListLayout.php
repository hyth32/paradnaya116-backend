...
abstract class BaseApplicationListLayout extends Table
{
                    ...
                    DropDown::make()
                        ...
                        ->list([
                            Link::make('Посмотреть')
                                ->icon('bs.eye')
                                ->route($this->getViewRouteName(), $application->id),
                            
                            Link::make('Редактировать')
                                ->canSee(!$application->isCompleted())
                                ->icon('bs.pencil')
                                ->route($this->getEditRouteName(), $application->id),
    ...
    {
        return match($type) {
            RentalApplicationType::Purchase => 'Заявка на покупку',
            RentalApplicationType::Service => 'Заявка на услугу',
            RentalApplicationType::Rental => 'Заявка на аренду',
